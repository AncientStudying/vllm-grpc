...
| flag | M4 cell | M4 verdict (time/bytes) | M5 verdict (time/bytes) | M5 CI | rationale |
|------|---------|-------------------------|-------------------------|-------|-----------|
| **[unexpected]** | `max_message_size/h2048/chat_stream` | client_bound/no_winner | no_winner/no_winner | [0, 0.06264] | time-metric verdict changed from 'client_bound' to 'no_winner' (M5 CI=[0, 0.06264]): M5 disagrees with M4 under real-wire transport |
| **[unexpected]** | `max_message_size/h4096/embed` | client_bound/no_winner | no_winner/no_winner | [0, 0.1215] | time-metric verdict changed from 'client_bound' to 'no_winner' (M5 CI=[0, 0.1215]): M5 disagrees with M4 under real-wire transport |
| **[unexpected]** | `max_message_size/h4096/chat_stream` | client_bound/no_winner | no_winner/no_winner | [0, 0.06264] | time-metric verdict changed from 'client_bound' to 'no_winner' (M5 CI=[0, 0.06264]): M5 disagrees with M4 under real-wire transport |
| **[unexpected]** | `max_message_size/h8192/embed` | no_winner/no_winner | server_bound/no_winner | [0, 0] | time-metric verdict changed from 'no_winner' to 'server_bound' (M5 CI=[0, 0]): M5 disagrees with M4 under real-wire transport |
| **[unexpected]** | `max_message_size/h8192/chat_stream` | client_bound/no_winner | no_winner/no_winner | [0, 0.06264] | time-metric verdict changed from 'client_bound' to 'no_winner' (M5 CI=[0, 0.06264]): M5 disagrees with M4 under real-wire transport |
| **[unexpected]** | `compression/h4096/embed` | no_winner/no_winner | server_bound/no_winner | [0, 0] | time-metric verdict changed from 'no_winner' to 'server_bound' (M5 CI=[0, 0]): M5 disagrees with M4 under real-wire transport |
| **[unexpected]** | `compression/h4096/chat_stream` | client_bound/no_winner | no_winner/no_winner | [0, 0.06264] | time-metric verdict changed from 'client_bound' to 'no_winner' (M5 CI=[0, 0.06264]): M5 disagrees with M4 under real-wire transport |
| **[unexpected]** | `compression/h8192/embed` | no_winner/no_winner | server_bound/no_winner | [0, 0] | time-metric verdict changed from 'no_winner' to 'server_bound' (M5 CI=[0, 0]): M5 disagrees with M4 under real-wire transport |
